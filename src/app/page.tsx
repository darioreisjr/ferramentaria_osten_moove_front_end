...
export default function Home() {
  return (
    <section className="flex flex-col justify-center items-center w-[1200px] m-auto pt-[33px]">
      <Image alt="" src="https://i.imgur.com/bNHewZ2.png" width={300} />
      <h1 className="text-5xl uppercase p-4 font-bold">Ferramentaria Osten Moove</h1>
      <h3 className="text-3xl pb-4">Reserva de ferramentas para mecânicos</h3>
      ...
      <ol className="pb-4">
        ...
        <li className="text-lg text-justify pb-1"><span className="font-semibold uppercase">Segurança:</span> O sistema garante que as ferramentas sejam reservadas apenas por mecânicos autorizados.</li>
      </ol>
